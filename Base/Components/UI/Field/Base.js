...
var BaseInput = module.exports = UIComponent.extend('BaseInput', {
    ...
    _bindListeners: function () {
        this.listen = {
            windowBlur: js.util.Dom.addRemovableListener(window, 'blur', JS.bind(this, 'blur')),
            windowClick: js.util.Dom.addRemovableListener(document, 'click', JS.bind(this, 'blur')),
...
var TestInput = BaseInput.extend('TestInput', {createEl: function () {
